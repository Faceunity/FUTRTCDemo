...
+(NSArray<FUBeautyParam *>*)setupSkinData{
    ...
    NSDictionary *defaultValueDic = @{@"blur_level":@(1.0),@"color_level":@(1.0),@"red_level":@(0.0),@"remove_pouch_strength":@(0),@"remove_nasolabial_folds_strength":@(0),@"eye_bright":@(0),@"tooth_whiten":@(0)};
...
+(NSArray<FUBeautyParam *>*)setupMakeupData{
   NSArray *prams = @[@"makeup_noitem",@"jianling",@"nuandong",@"hongfeng",@"Rose",@"shaonv"];
    NSDictionary *titelDic = @{@"origin":@"卸妆",@"jianling":@"减龄",@"nuandong":@"暖冬",@"hongfeng":@"红枫",@"Rose":@"玫瑰",@"shaonv":@"少女"};
   NSMutableArray *array = [[NSMutableArray alloc] init];
   for (NSString *str in prams) {
       FUBeautyParam *modle = [[FUBeautyParam alloc] init];
       modle.mParam = str;
