...
+(NSArray<FUBeautyParam *>*)setupSkinData{
    ...
    NSDictionary *defaultValueDic = @{@"blur_level":@(1.0),@"color_level":@(1.0),@"red_level":@(0),@"sharpen":@(0),@"remove_pouch_strength":@(0),@"remove_nasolabial_folds_strength":@(0),@"eye_bright":@(0),@"tooth_whiten":@(0)};
